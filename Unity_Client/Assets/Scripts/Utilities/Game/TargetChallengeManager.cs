...
public class TargetChallengeManager : MonoBehaviour
{
	...
	private void EndChallenge()
	{
		...
		string endChallengeMessage = $"Challenge complete! Final time: {timer:F2}s";

		Debug.Log(endChallengeMessage);

		GestureSystemManager.instance.AddToActionLog(endChallengeMessage);
	}
